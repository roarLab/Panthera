...
if(key_command_pub_CONFIG_INCLUDED)
  return()
endif()
set(key_command_pub_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(key_command_pub_SOURCE_PREFIX /home/joel/encoder_publisher_ws/src/key_command_pub)
  set(key_command_pub_DEVEL_PREFIX /home/joel/encoder_publisher_ws/devel)
  set(key_command_pub_INSTALL_PREFIX "")
  set(key_command_pub_PREFIX ${key_command_pub_DEVEL_PREFIX})
else()
  set(key_command_pub_SOURCE_PREFIX "")
  set(key_command_pub_DEVEL_PREFIX "")
  set(key_command_pub_INSTALL_PREFIX /home/joel/encoder_publisher_ws/install)
  set(key_command_pub_PREFIX ${key_command_pub_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'key_command_pub' is deprecated")
...
set(key_command_pub_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(key_command_pub_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${key_command_pub_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'key_command_pub' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'key_command_pub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joel/encoder_publisher_ws/src/key_command_pub/${idir}'.  ${_report}")
    endif()
    _list_append_unique(key_command_pub_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND key_command_pub_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND key_command_pub_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT key_command_pub_NUM_DUMMY_TARGETS)
      set(key_command_pub_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::key_command_pub::wrapped-linker-option${key_command_pub_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR key_command_pub_NUM_DUMMY_TARGETS "${key_command_pub_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::key_command_pub::wrapped-linker-option${key_command_pub_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND key_command_pub_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(key_command_pub_LIBRARY_DIRS ${lib_path})
      list(APPEND key_command_pub_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'key_command_pub'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND key_command_pub_LIBRARIES ${lib})
    endif()
  endif()
...
set(key_command_pub_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${key_command_pub_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 key_command_pub_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${key_command_pub_dep}_FOUND)
      find_package(${key_command_pub_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${key_command_pub_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(key_command_pub_INCLUDE_DIRS ${${key_command_pub_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(key_command_pub_LIBRARIES ${key_command_pub_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${key_command_pub_dep}_LIBRARIES})
  _list_append_deduplicate(key_command_pub_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(key_command_pub_LIBRARIES ${key_command_pub_LIBRARIES})

  _list_append_unique(key_command_pub_LIBRARY_DIRS ${${key_command_pub_dep}_LIBRARY_DIRS})
  list(APPEND key_command_pub_EXPORTED_TARGETS ${${key_command_pub_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${key_command_pub_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
