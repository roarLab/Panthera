...
if(can_encoder_pub_CONFIG_INCLUDED)
  return()
endif()
set(can_encoder_pub_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(can_encoder_pub_SOURCE_PREFIX /home/joel/encoder_publisher_ws/src/can_encoder_pub)
  set(can_encoder_pub_DEVEL_PREFIX /home/joel/encoder_publisher_ws/devel)
  set(can_encoder_pub_INSTALL_PREFIX "")
  set(can_encoder_pub_PREFIX ${can_encoder_pub_DEVEL_PREFIX})
else()
  set(can_encoder_pub_SOURCE_PREFIX "")
  set(can_encoder_pub_DEVEL_PREFIX "")
  set(can_encoder_pub_INSTALL_PREFIX /home/joel/encoder_publisher_ws/install)
  set(can_encoder_pub_PREFIX ${can_encoder_pub_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'can_encoder_pub' is deprecated")
...
set(can_encoder_pub_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(can_encoder_pub_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${can_encoder_pub_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'can_encoder_pub' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'can_encoder_pub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joel/encoder_publisher_ws/src/can_encoder_pub/${idir}'.  ${_report}")
    endif()
    _list_append_unique(can_encoder_pub_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND can_encoder_pub_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND can_encoder_pub_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT can_encoder_pub_NUM_DUMMY_TARGETS)
      set(can_encoder_pub_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::can_encoder_pub::wrapped-linker-option${can_encoder_pub_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR can_encoder_pub_NUM_DUMMY_TARGETS "${can_encoder_pub_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::can_encoder_pub::wrapped-linker-option${can_encoder_pub_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND can_encoder_pub_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(can_encoder_pub_LIBRARY_DIRS ${lib_path})
      list(APPEND can_encoder_pub_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'can_encoder_pub'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND can_encoder_pub_LIBRARIES ${lib})
    endif()
  endif()
...
set(can_encoder_pub_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${can_encoder_pub_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 can_encoder_pub_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${can_encoder_pub_dep}_FOUND)
      find_package(${can_encoder_pub_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${can_encoder_pub_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(can_encoder_pub_INCLUDE_DIRS ${${can_encoder_pub_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(can_encoder_pub_LIBRARIES ${can_encoder_pub_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${can_encoder_pub_dep}_LIBRARIES})
  _list_append_deduplicate(can_encoder_pub_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(can_encoder_pub_LIBRARIES ${can_encoder_pub_LIBRARIES})

  _list_append_unique(can_encoder_pub_LIBRARY_DIRS ${${can_encoder_pub_dep}_LIBRARY_DIRS})
  list(APPEND can_encoder_pub_EXPORTED_TARGETS ${${can_encoder_pub_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${can_encoder_pub_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
