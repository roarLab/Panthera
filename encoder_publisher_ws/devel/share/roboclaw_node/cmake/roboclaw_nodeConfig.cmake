...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roboclaw_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joel/encoder_publisher_ws/src/roboclaw_node/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT roboclaw_node_NUM_DUMMY_TARGETS)
      set(roboclaw_node_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::roboclaw_node::wrapped-linker-option${roboclaw_node_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR roboclaw_node_NUM_DUMMY_TARGETS "${roboclaw_node_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::roboclaw_node::wrapped-linker-option${roboclaw_node_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND roboclaw_node_LIBRARIES "${interface_target_name}")
