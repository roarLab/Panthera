...
if(ds4_driver_CONFIG_INCLUDED)
  return()
endif()
set(ds4_driver_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(ds4_driver_SOURCE_PREFIX /home/joel/encoder_publisher_ws/src/ds4_driver)
  set(ds4_driver_DEVEL_PREFIX /home/joel/encoder_publisher_ws/devel)
  set(ds4_driver_INSTALL_PREFIX "")
  set(ds4_driver_PREFIX ${ds4_driver_DEVEL_PREFIX})
else()
  set(ds4_driver_SOURCE_PREFIX "")
  set(ds4_driver_DEVEL_PREFIX "")
  set(ds4_driver_INSTALL_PREFIX /home/joel/encoder_publisher_ws/install)
  set(ds4_driver_PREFIX ${ds4_driver_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'ds4_driver' is deprecated")
...
set(ds4_driver_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/joel/encoder_publisher_ws/devel/include " STREQUAL " ")
  set(ds4_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/joel/encoder_publisher_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://wiki.ros.org/ds4_driver " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/ds4_driver' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Naoki Mizuno <naoki.mizuno.256@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${ds4_driver_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ds4_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ds4_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joel/encoder_publisher_ws/src/ds4_driver/${idir}'.  ${_report}")
    endif()
    _list_append_unique(ds4_driver_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND ds4_driver_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND ds4_driver_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT ds4_driver_NUM_DUMMY_TARGETS)
      set(ds4_driver_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ds4_driver::wrapped-linker-option${ds4_driver_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ds4_driver_NUM_DUMMY_TARGETS "${ds4_driver_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ds4_driver::wrapped-linker-option${ds4_driver_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ds4_driver_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(ds4_driver_LIBRARY_DIRS ${lib_path})
      list(APPEND ds4_driver_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'ds4_driver'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND ds4_driver_LIBRARIES ${lib})
    endif()
  endif()
...
set(ds4_driver_EXPORTED_TARGETS "ds4_driver_generate_messages_cpp;ds4_driver_generate_messages_eus;ds4_driver_generate_messages_lisp;ds4_driver_generate_messages_nodejs;ds4_driver_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${ds4_driver_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 ds4_driver_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${ds4_driver_dep}_FOUND)
      find_package(${ds4_driver_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ds4_driver_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(ds4_driver_INCLUDE_DIRS ${${ds4_driver_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(ds4_driver_LIBRARIES ${ds4_driver_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${ds4_driver_dep}_LIBRARIES})
  _list_append_deduplicate(ds4_driver_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(ds4_driver_LIBRARIES ${ds4_driver_LIBRARIES})

  _list_append_unique(ds4_driver_LIBRARY_DIRS ${${ds4_driver_dep}_LIBRARY_DIRS})
  list(APPEND ds4_driver_EXPORTED_TARGETS ${${ds4_driver_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "ds4_driver-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${ds4_driver_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
