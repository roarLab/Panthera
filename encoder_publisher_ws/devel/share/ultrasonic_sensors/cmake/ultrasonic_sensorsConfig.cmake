...
if(ultrasonic_sensors_CONFIG_INCLUDED)
  return()
endif()
set(ultrasonic_sensors_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(ultrasonic_sensors_SOURCE_PREFIX /home/joel/encoder_publisher_ws/src/ultrasonic_sensors)
  set(ultrasonic_sensors_DEVEL_PREFIX /home/joel/encoder_publisher_ws/devel)
  set(ultrasonic_sensors_INSTALL_PREFIX "")
  set(ultrasonic_sensors_PREFIX ${ultrasonic_sensors_DEVEL_PREFIX})
else()
  set(ultrasonic_sensors_SOURCE_PREFIX "")
  set(ultrasonic_sensors_DEVEL_PREFIX "")
  set(ultrasonic_sensors_INSTALL_PREFIX /home/joel/encoder_publisher_ws/install)
  set(ultrasonic_sensors_PREFIX ${ultrasonic_sensors_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'ultrasonic_sensors' is deprecated")
...
set(ultrasonic_sensors_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(ultrasonic_sensors_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${ultrasonic_sensors_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ultrasonic_sensors' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ultrasonic_sensors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joel/encoder_publisher_ws/src/ultrasonic_sensors/${idir}'.  ${_report}")
    endif()
    _list_append_unique(ultrasonic_sensors_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND ultrasonic_sensors_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND ultrasonic_sensors_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT ultrasonic_sensors_NUM_DUMMY_TARGETS)
      set(ultrasonic_sensors_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ultrasonic_sensors::wrapped-linker-option${ultrasonic_sensors_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ultrasonic_sensors_NUM_DUMMY_TARGETS "${ultrasonic_sensors_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ultrasonic_sensors::wrapped-linker-option${ultrasonic_sensors_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ultrasonic_sensors_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(ultrasonic_sensors_LIBRARY_DIRS ${lib_path})
      list(APPEND ultrasonic_sensors_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'ultrasonic_sensors'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND ultrasonic_sensors_LIBRARIES ${lib})
    endif()
  endif()
...
set(ultrasonic_sensors_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${ultrasonic_sensors_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 ultrasonic_sensors_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${ultrasonic_sensors_dep}_FOUND)
      find_package(${ultrasonic_sensors_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ultrasonic_sensors_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(ultrasonic_sensors_INCLUDE_DIRS ${${ultrasonic_sensors_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(ultrasonic_sensors_LIBRARIES ${ultrasonic_sensors_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${ultrasonic_sensors_dep}_LIBRARIES})
  _list_append_deduplicate(ultrasonic_sensors_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(ultrasonic_sensors_LIBRARIES ${ultrasonic_sensors_LIBRARIES})

  _list_append_unique(ultrasonic_sensors_LIBRARY_DIRS ${${ultrasonic_sensors_dep}_LIBRARY_DIRS})
  list(APPEND ultrasonic_sensors_EXPORTED_TARGETS ${${ultrasonic_sensors_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${ultrasonic_sensors_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
